...
module.exports = {
  ...
  // 正式环境
  // 网站
  WEB_HOST: '"https://mob.kangmei.com.cn"',
  ...
  // 康美e抓药H5
  E_MEDICINE_HOST: '"https://yhlwx.kangmei.com.cn"',

  // 测试环境
  // 网站
  // WEB_HOST: '"https://tmob.kangmeiyaohulu.com"',
  // // 跳转appH5地址
  // WEB_HOST_APP: '"https://tmob.kangmeiyaohulu.com"',
  // // .net 接口 默认host
