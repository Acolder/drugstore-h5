      ...
      >
        ...
        <section class="box2" id="tzjd">
          ...
          <div class="heartrate-box">
            ...
            <img src="./img/xh_icon_zk.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="anMore('pan1')"
                 v-show="pan1">
            <img src="./img/xh_icon_sq.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="anMore('pan1')"
                 v-show="!pan1">
          ...
          <div class="heartrate-box">
            ...
            <img src="./img/xh_icon_zk.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="anMore('pan2')"
                 v-show="pan2">
            <img src="./img/xh_icon_sq.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="anMore('pan2')"
                 v-show="!pan2">
        ...
        <section class="box2" id="viscera">
          <div class="viscera-header">
            ...
            <ul>
              <li v-for="item in viscera2" v-bind:key="item.index">
                <img :src='"./img/18/"+item.key+".@2x.png"' alt="" class="body-ok" :style="{width:!viOk?'100px':'127px'}">
          ...
          <div v-for="(item, index) in viscera2" v-bind:key="item.key" v-show="!viOk">
            ...
            <div class="heartrate-box">
              ...
              <img src="./img/xh_icon_zk.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="viMore(index)"
                   v-show="vi[index].value&&item.content">
              <img src="./img/xh_icon_sq.png" alt="" class="heartrate-boxUp heartrate-imgSize" @click.self="viMore(index)"
          ...
          <ul>
            <li>
              <div class="zcyLine-top">
                ...
                <div  class="zcyLine-topCenter">中成药调理</div>
                <div class="zcyLine-topRight"></div>
              </div>
              <div class="zcyLine-bot">
                <div  class="zcyLine-botLeft">
                  <h6>三七粉</h6>
                  <p>三七的功用，原来可用“止血、散瘀、 定痛”六个字来概括，所以，历来都...</p>
                  <i>湿热困脾</i>
                </div>
        ...
        <section class="box2 zytlBox">
          ...
          <div class="ysjyBox">
            ...
            <div class="ysjyButton">
              <i class="ysjyChoose">宜</i>
              <i>忌</i>
            </div>
            <div class="ysjyP">
              养生，动词也，亦可为名词。原指道家通过各种方法颐养生命、增强体质、预防疾病，从而达到延年益寿的一种医事活动。养，即调养、保养、补养之意；生，即生命、生存、生长之意。
            </div>
          </div>
          <ul>
            <li>
        ...
        <!--4.4 养生阅读-->
        <dl class="box2 zytlBox" id="read" v-if="readCons.length&&readCons.length > 0">
          <dt class="zcy-title">
            <img  src="./img/xh_icon_ysys@3x.png" alt="">
          <div>养生阅读</div>
          </dt>
          <dd v-for="news in readCons" v-bind:key="news.id" @click="download()">
            <div>
              <h5>{{news.title}}</h5>
              <i class="readI">湿热困脾</i>
              <div class="span">
                <span>{{news.sourceName}}</span>
                <img src="./img/xh_icon_eyes@3x.png" alt="" class="spanImg" style="margin-left: 10px;margin-right: 1px;">
                <span>{{news.readingQuantity}}</span>
                <span style="min-width: 65px;margin-left: 10px;">{{news.lastModifiedTime_parse}}</span>
              </div>
            </div>
        ...
        <!--4.4 运动保健-->
        <dl class="box2 zytlBox" id="movement">
          <dt class="zcy-title">
            <img  src="./img/xh_icon_ydbj@3x.png" alt="">
          <div>运动保健</div>
          </dt>
        ...
        <!--2.1 理疗指数-->
        <!-- <section class="box2" id="tjt">
           <h1>理疗指数:</h1>
           <div class="taiji">
             <div class="text" id="taijiFont"></div>
             <canvas id="canvas" style="position: absolute;top:0;left: 50%;margin-left: -100px" width="200"
                     height="200"></canvas>
           </div>
           <div class="mytap">
             <div class="item">
               <div class="num">{{result.measurement_result.app_lowest_heart_rate}}</div>
               <div class="text">阴指数</div>
             </div>
             <div class="item">
               <div class="num">{{result.measurement_result.app_highest_heart_rate}}</div>
               <div class="text">阳指数</div>
             </div>
           </div>
         </section>
         <section class="box2" id="llzs">
           <div class="top-box">
             <h1>湿气指数:</h1>
             <div class="jindu-box">
               <div class="jindutiao">
                 <div class="step" :style="{width:(result.physical_therapy_explain.f2*1)+'%'}">
                   <div class="step-icon">
                     <span class="icon">{{result.physical_therapy_explain.f2}}</span>
                     <span class="text">{{result.physical_therapy_explain.f2 > 3 ? '湿气一般' : ''}}</span>
                   </div>
                 </div>
                 <div class="num-box">
                   <div class="num">
           ...
           <div class="bottom-box">
             ...
             <div class="jindu-box">
               <div class="jindutiao">
                 <div class="step" :style="{width:(result.physical_therapy_explain.f3*1)+'%'}">
                   <div class="step-icon">
                     <span class="icon">{{result.physical_therapy_explain.f3}}</span>
                     <span class="text">{{result.physical_therapy_explain.f2 > 3 ? '血瘀一般' : ''}}</span>
                   </div>
                 </div>
                 <div class="num-box">
                   <div class="num">
