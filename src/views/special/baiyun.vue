<template>
  <div class="mantain" :class="from!=='app' && from!=='appv2'?'pdt44':''">
      <mt-header fixed title="同仁堂专题" v-if="from !== 'app' && from!=='appv2'">
      ...
      <a href="" style="">
        <img src="./img/baiyun/banner.png" alt="">
        <img src="./img/baiyun/title.png" alt="">
      </a>
    </div>
    <div class="bg">
...
.mantain{
 ...
 .cosmetology-mian{
    ...
    .bg {
      width: 100vw;
      height: auto;
      background-image: url(./img/baiyun/bg.png);
    ...
    .cosmetology-list{
      ...
      .list-box{
        ...
        overflow-x: hidden;
        height: 38.6666667vw;
        	box-shadow: 0px 20px 20px 0px rgba(90, 137, 120, 0.44);
        background-color: rgba(255,255,255, .65);
        // background-image: url(./img/tongren/bg.png);
        background-repeat: no-repeat;
        background-size: cover; 
        box-sizing: border-box;
        border-radius: 20px;
        border: solid 1px rgba(142,174,102, .5);
        // opacity: 0.5;
          .box-main{
            width: 100%;
            height: 100%;
