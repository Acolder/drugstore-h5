    ...
    <div id="page">
      ...
      <div class="container" id="body">
        ...
        <section class="box2" id="jljd">
          ...
          <div class="body">
            <div class="pa" v-if="result.channels_and_collaterals_explain_notices&&result.channels_and_collaterals_explain_notices.length > 0">
...
export default {
  ...
  methods: {
    jumpTap2(key) {
      ...
      body.scrollTop = scrollTop - 115 + 60;
      setTimeout(() => {
    ...
    getReportResult() {
      ...
      let provice = this.$route.query.provice;
