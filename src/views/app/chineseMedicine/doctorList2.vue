<template>
  <div id="doctorCNOnline">
    <div class="page">
      <ul class="doctorList"
          v-infinite-scroll="getDoctorCNList"
    ...
    .item {
      ...
      .right {
        ...
        .R-top {
          ...
          h2 { width: 22px; font-size: 13px; line-height: 15px; font-weight: lighter; word-wrap: break-word; letter-spacing: 20px; }
          h3 { width: 22px; font-size: 12px; line-height: 15px; font-weight: lighter; word-wrap: break-word; letter-spacing: 20px; color: #967D72 }
          .btn-order {
            /* position: absolute;
             right: 20px;*/
            height: 50px;
